...
export default class GetListUserView extends Component {
	...
	constructor(props){
   	...
   	componentDidMount = () => {
      fetch('https://kins-node.herokuapp.com/users', {
         method: 'GET'
      })
...
AppRegistry.registerComponent('GetListUserView', () => GetListUserView)
